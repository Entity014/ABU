...
class Ps4(Node):
    ...
    def gui(self, msg_temp):
        block = [
            [0, int(self.height_frame - 50), 100, 50],
            [0, int(self.height_frame - 100), 100, 50],
            [0, int(self.height_frame - 150), 100, 50],
        ]
    ...
    def draw_gauge(
        self, frame, x_cord, y_cord, thickness, radius, circle_colour, value_pwm=0
    ):
